...
const RevealPage = ({ onNext }: RevealPageProps) => {
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center px-6 text-center relative overflow-hidden">
      ...
      <motion.h2
        ...
        className="text-2xl font-light text-gray-800 mb-12"
        style={{
      ...
      <div className="relative">
        ...
        >
          ...
          >
            {/* Ribbon horizontal */}
            <motion.div
              className="absolute top-0 left-1/2 transform -translate-x-1/2 w-6 h-full bg-gradient-to-b from-amber-400 to-yellow-500"
              animate={
                isRevealed
                  ? {
                      scaleY: 0,
            ...
            {/* Ribbon vertical */}
            <motion.div
              className="absolute top-1/2 left-0 transform -translate-y-1/2 w-full h-6 bg-gradient-to-r from-amber-400 to-yellow-500"
              animate={
                isRevealed
                  ? {
                      scaleX: 0,
            ...
            {/* Bow */}
            <motion.div
              className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-3 text-amber-500"
              animate={
                isRevealed
                  ? {
                      scale: 0,
