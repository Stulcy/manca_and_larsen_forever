...
const GiftDetailsPage = ({
  ...
  return <div className="h-full flex flex-col px-6 py-8 overflow-y-auto">
      ...
      duration: 0.6
        ...
        <div className="w-full h-48 bg-gradient-to-br from-amber-50 to-yellow-50 rounded-2xl mb-6 flex items-center justify-center">
        ...
        <p className="text-gray-600 leading-relaxed mb-6">Ful bo fino. Oblubmo!</p>
